...
let peanut = new Product(6, "Peanuts", 14.05, "assets/products/car.jpg");
...
let products = [
    ...
    new Product(5, "Umbrella", 8.95, "assets/products/Umbrella.jpg"),
    peanut,
    new Product(7, "Deodorant", 6.99, "assets/products/Deodorant.png"),
    new Product(8, "Mechanical Drill", 122.75, "assets/products/Mechanical_Drill.jpg"),
];
...
document.addEventListener('click', function (event) {
    ...
    if (containsClass(event.target, 'add-cart')) {
        ...
        if (product) {
            console.log("got in")
            let quantity = document.getElementById('mySelect'+id).value;
